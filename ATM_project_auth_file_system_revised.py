...
def login():
    ...
    if is_valid_account_number:
        ...
        user = databaseu.authenticated_user(account_number_from_user, password)
...
def register():
    ...
    is_user_created = databaseu.create(account_number, first_name, last_name, email, password)
